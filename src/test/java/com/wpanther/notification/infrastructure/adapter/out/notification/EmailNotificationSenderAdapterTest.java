...
@DisplayName("EmailNotificationSenderAdapter Tests")
class EmailNotificationSenderAdapterTest {
    ...
    private EmailNotificationSenderAdapter emailNotificationSenderAdapter;

    @BeforeEach
    void setUp() {
        emailNotificationSenderAdapter = new EmailNotificationSenderAdapter(mailSender, templateEngine);
    ...
    class SendMethodTests {
        ...
        void testSendEmailWithDirectBody() throws Exception {
            ...
            // Act
            emailNotificationSenderAdapter.send(notification);
        ...
        void testThrowNotificationExceptionOnMessagingException() {
            ...
            assertThatThrownBy(() -> emailNotificationSenderAdapter.send(notification))
    ...
    class SupportsMethodTests {
        ...
        void testSupportsEmailChannel() {
            // Act
            boolean result = emailNotificationSenderAdapter.supports(NotificationChannel.EMAIL);
        ...
        void testDoesNotSupportOtherChannels() {
            // Act & Assert
            assertThat(emailNotificationSenderAdapter.supports(NotificationChannel.WEBHOOK)).isFalse();
            assertThat(emailNotificationSenderAdapter.supports(NotificationChannel.SMS)).isFalse();
            assertThat(emailNotificationSenderAdapter.supports(NotificationChannel.IN_APP)).isFalse();
        }
    }
}
