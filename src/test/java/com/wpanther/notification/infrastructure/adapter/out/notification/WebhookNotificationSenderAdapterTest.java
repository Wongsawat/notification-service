...
@DisplayName("WebhookNotificationSenderAdapter Tests")
class WebhookNotificationSenderAdapterTest {
    ...
    private WebhookNotificationSenderAdapter webhookNotificationSenderAdapter;

    @BeforeEach
    void setUp() {
        objectMapper = new ObjectMapper();
        webhookNotificationSenderAdapter = new WebhookNotificationSenderAdapter(webClient, objectMapper);
    ...
    class SendMethodTests {
        ...
        void testSendWebhookSuccessfully() throws NotificationException {
            ...
            // Act
            webhookNotificationSenderAdapter.send(notification);
        ...
        void testThrowNotificationExceptionOnErrorStatus() {
            ...
            // Act & Assert
            assertThatThrownBy(() -> webhookNotificationSenderAdapter.send(notification))
    ...
    class UrlValidationTests {
        ...
        void testAllowHttpScheme() throws NotificationException {
            ...
            webhookNotificationSenderAdapter.send(notification); // must not throw
    ...
    class SupportsMethodTests {
        ...
        void testSupportsWebhookChannel() {
            // Act
            boolean result = webhookNotificationSenderAdapter.supports(NotificationChannel.WEBHOOK);
        ...
        void testDoesNotSupportOtherChannels() {
            // Act & Assert
            assertThat(webhookNotificationSenderAdapter.supports(NotificationChannel.EMAIL)).isFalse();
            assertThat(webhookNotificationSenderAdapter.supports(NotificationChannel.SMS)).isFalse();
            assertThat(webhookNotificationSenderAdapter.supports(NotificationChannel.IN_APP)).isFalse();
        }
    }
}
